chrome.extension.sendMessage({}, function(response) {
	...
	if (document.readyState === "complete") {
		...
		var links = [
			...
			'commentaires.ch',
			'contribuables.org',
			'corruptionssida.canalblog.com',
			'diktacratie.com',
			'dondevamos.canalblog.com',
			'doubimag.fr',
			'dreuz.info',
			'edukactus.wordpress.com',
			'egaliteetreconciliation.fr',
			'enquete-debat.fr',
			'espritsciencemetaphysiques.com',
			'extraterrestre-ovni.blogspot.fr',
			'fawkes-news.blogspot.fr',
			'fdesouche.com',
			'footballfrance.fr',
			'fr.novopress.info',
			'fr.sott.net',
			'francefoire.fr',
			'henrymakow.wordpress.com',
